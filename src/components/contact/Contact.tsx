        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-5">
            <a
              ...
              className="flex gap-2 mt-6 bg-secondary-foreground text-primary text-center border border-secondary rounded-full px-6 py-3 font-medium shadow-[0_0_10px_hsl(var(--color-primary))] hover:scale-105 transition"
            >
              Send Me an Email
              <Mail />
            </a>
            ...
            <a
              ...
              className="flex items-center gap-2 mt-6 bg-secondary-foreground text-primary text-center border border-secondary rounded-full px-6 py-3 font-medium shadow-[0_0_10px_hsl(var(--color-primary))] hover:scale-105 transition"
            >
              Chat on WhatsApp
