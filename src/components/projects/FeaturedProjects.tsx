...
const Projects = () => {
  ...
  const projects: Project[] = [
    ...
    {
      title: "HiveMatch",
      description: "A Startup networking platform that connects Job Seekers based on shared interests and activities to Recruiters.",
      image: "/images/hivematch.png",
      link: "https://getdhub.vercel.app/client",
      repo: "https://github.com/DHuB-Technologies/d-hub-frontend",
